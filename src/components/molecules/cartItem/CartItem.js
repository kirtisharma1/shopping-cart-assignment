    ...
    <li className="cart-item" aria-label={item.name}>
      ...
      <div className="cart-item__details">
        ...
        <div className="cart-item__details__price-quantity">
          <div>
            <button className="btn-full cart-item__details__price-quantity__substract" onClick={() => updateCart(item, 'substract')} aria-label={SUBTRACT_ITEM_FROM_CART_ARIA_LABEL + ' ' + item.quantity}><span>-</span></button>
            <span>{item.quantity}</span>
            <button className="btn-full cart-item__details__price-quantity__add" onClick={() => updateCart(item, 'add')} aria-label={ADD_ITEM_TO_CART_ARIA_LABEL + ' ' + item.quantity}><span>+</span></button>
            <span>X</span>
